...
class SEOToolsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('seotools.facebook', function ($app) {
            return new FacebookGraph($app['config']->get('seotools.facebook.defaults', []));
        });
        ...
        $this->app->bind(Contracts\FacebookGraph::class, 'seotools.facebook');
